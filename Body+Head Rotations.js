...
var killAuraSlientRotation = killAuraModule.getValue("SilentRotation");
...
function Rotations() {
	...
	this.onUpdate = function() {
		...
		if(player != null)
		if(mc.thePlayer.getDistanceToEntity(player) > killAuraReach.get() || player.isDead || mc.thePlayer.isDead)
			player = null;
	}
	this.onAttack = function(event) {
		...
		if(scaffoldModule.getState() || towerModule.getState() || (player != null && killAuraModule.getState() && killAuraSlientRotation.get()))
		...
		else if(scaffoldModule.getState() || towerModule.getState() || killAuraModule.getState()){
