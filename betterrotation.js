...
var scriptVersion = 1.2; // The version of your script 
...
var bowAimbotModule = moduleManager.getModule("BowAimbot");
var fuckerModule = moduleManager.getModule("Fucker");
var civBreakModule = moduleManager.getModule("CivBreak");
var nukerModule = moduleManager.getModule("Nuker");
var chestAuraModule = moduleManager.getModule("ChestAura");
...
function Rotations() {
	...
	this.onAttack = function(event) {
		...
		if(scaffoldModule.getState() || towerModule.getState() || (player != null && killAuraModule.getState()) || derpModule.getState() || bowAimbotModule.getState() || fuckerModule.getState() || civBreakModule.getState() || nukerModule.getState() || chestAuraModule.getState())
		...
		else if(scaffoldModule.getState() || towerModule.getState() || killAuraModule.getState() || derpModule.getState() || bowAimbotModule.getState() || fuckerModule.getState() || civBreakModule.getState() || nukerModule.getState() || chestAuraModule.getState()){
